package com.jim.springkafka.dispatch.integration;

import java.util.concurrent.TimeUnit;
import java.util.concurrent.atomic.AtomicInteger;

import com.jim.springkafka.dispatch.config.DispatchConfiguration;
...
public class OrderDispatchIntegrationTest {
    ...
    public void testOrderDispatchFlow() throws Exception {
        OrderCreated orderCreated = EventDataTest.buildOrderCreatedEvent(randomUUID(), "my-item");
        sendMessage(orderCreated);
    ...
    private void sendMessage(Object data) throws Exception {
        kafkaTemplate.send(MessageBuilder
                .withPayload(data)
                .setHeader(KafkaHeaders.TOPIC, OrderDispatchIntegrationTest.ORDER_CREATED_TOPIC)
                .build()).get();
    }
}