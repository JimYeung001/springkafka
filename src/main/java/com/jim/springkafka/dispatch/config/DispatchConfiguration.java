package com.jim.springkafka.dispatch.config;
...
@Configuration
@ComponentScan(basePackages = "com.jim.springkafka.dispatch")
public class DispatchConfiguration {
    ...
    public ConsumerFactory<String, Object> consumerFactory(@Value("${spring.kafka.bootstrap-servers}") String bootstrapServers) {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, OrderCreated.class.getName());
